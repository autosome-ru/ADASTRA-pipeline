...
if __name__ == '__main__':
    ...
    plt.ylim(0.9, 405)
    plt.savefig(os.path.expanduser('~/phantom_style/total_snp_barplot_TF.png'), dpi=300)
    # plt.show()
    plt.close(fig)
    ...
    plt.ylabel('Number of SNP calls')
    plt.ylim((pow(10, -0.5), pow(10, 2.5)))
    plt.yscale('log')
    plt.xlabel('Cell types, sorted by number of datasets')
    plt.savefig(os.path.expanduser('~/phantom_style/total_snp_barplot_CL.png'), dpi=300)
    # plt.show()
    plt.close(fig)
    ...
    plt.savefig(os.path.expanduser('~/phantom_style/datasets_barplot_TF.png'), dpi=300)
    # plt.show()
    plt.close(fig)
    ...
    plt.savefig(os.path.expanduser('~/phantom_style/datasets_barplot_CL.png'), dpi=300)
    # plt.show()
    plt.close(fig)
    ...
    plt.savefig(os.path.expanduser('~/phantom_style/unique_snp_barplot_TF.png'), dpi=300)
    # plt.show()
    ...
    plt.legend(loc='upper right')
    plt.savefig(os.path.expanduser('~/phantom_style/unique_snp_barplot_CL.png'), dpi=300)
    # plt.show()
