...
for state_s in ('int_6', 'full_5_and_6', 'full_6_but_1.33', 'full_6_but_2.5', 'full_6'):
    for CAIC in range(3, 6):
        ...
        max_tr = {}
        for BAD in states:
            t[BAD] = pd.read_table(os.path.expanduser('D:\Sashok\Desktop/counts/counts_deltaqm_{}_{:.2f}.tsv'.format(model, BAD)))
        ...
        plt.savefig(os.path.expanduser('D:\Sashok\Desktop/AC_5/Figure_AS_5_PR_{}.png'.format(model)), dpi=300)
        ...
        plt.savefig(os.path.expanduser('D:\Sashok\Desktop/AC_5/Figure_AS_5_ROC_{}.png'.format(model)), dpi=300)
