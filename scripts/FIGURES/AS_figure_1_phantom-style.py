...
if __name__ == '__main__':
    ...
    plt.savefig(os.path.expanduser('~/AC_1/Figure_AS_1_total_snp_barplot_TF.png'), dpi=300)
    # plt.show()
    plt.close(fig)
    ...
    plt.savefig(os.path.expanduser('~/AC_1/Figure_AS_1_total_snp_barplot_CL.png'), dpi=300)
    # plt.show()
    plt.close(fig)
    print(len(vals), sum(vals))
    print(d['unique_SNPs'])
    ...
    plt.savefig(os.path.expanduser('~/AC_1/Figure_AS_1_datasets_barplot_TF.png'), dpi=300)
    # plt.show()
    plt.close(fig)
    print(len(vals), sum(vals))
    ...
    plt.savefig(os.path.expanduser('~/AC_1/Figure_AS_1_datasets_barplot_CL.png'), dpi=300)
    # plt.show()
    plt.close(fig)
    print(len(vals), sum(vals))
    ...
    plt.savefig(os.path.expanduser('~/AC_1/Figure_AS_1_unique_snp_barplot_TF.png'), dpi=300)
    # plt.show()
    ...
    plt.savefig(os.path.expanduser('~/AC_1/Figure_AS_1_unique_snp_barplot_CL.png'), dpi=300)
    # plt.show()
