...
df1 = pd.read_table('statistics_for_TFs_{}_total_cov.tsv'.format('ref'))
df1 = df1.drop('#name',1)
df1 = df1.drop('name',1)

df2 = pd.read_table('statistics_for_TFs_{}_total_cov.tsv'.format('alt'))
df2 = df2.drop('#name',1)
df2 = df2.drop('name',1)
...
bottom_plot.set_xlabel("x: total_cover >= x")
