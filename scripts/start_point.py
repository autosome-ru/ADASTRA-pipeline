        ...
        if args['validation']:
            ...
            with open(create_merged_vcf_path_function(bad_group)) as m_vcf:
                ...
                GS = BADEstimation.GenomeSegmentator(
                    ...
                    allele_reads_tr=5,
                    segmentation_mode='corrected',
                    # prior={1: 0.3171517351161305,
                    #        1.5: 0.08539171461353395,
                    #        2: 0.4631620065111548,
                    #        3: 0.11838210553354506,
                    #        4: 0.0016673481028903335,
                    #        5: 6.60461450855278e-05,
                    #        6: 0.005045457210536672}
                    # # K562
                )
                GS.estimate_BAD()
